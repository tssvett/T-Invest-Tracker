CREATE TABLE IF NOT EXISTS invest.users_share (
    ...
    CONSTRAINT user_share_user_fk FOREIGN KEY (user_id) REFERENCES invest.users (user_id),
    CONSTRAINT user_share_share_fk FOREIGN KEY (share_uid) REFERENCES invest.share (uid)
);
